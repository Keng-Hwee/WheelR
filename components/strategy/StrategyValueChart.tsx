...
import { Card, CardBody, CardHeaderText } from '../common/Card'

const StrategyValueChart = () => {
  Chart.register(
    CategoryScale,
    LinearScale,
    PointElement,
  ...
  return (
    ...
    <Card>
      <CardHeaderText text="VALUES"></CardHeaderText>
...
export default StrategyValueChart
